...
להלן המיפוי של **19 ה־Stories ב־Jira**, כולל KAN, REQ והאחראי.

| חבר צוות            | KAN      | REQ       | Story                        |
| ------------------- | -------- | --------- | ---------------------------- |
| **נוריאל אלטשטיין** | `KAN-8`  | `REQ-001` | יצירת חשבון                  |
|                     | `KAN-9`  | `REQ-002` | התחברות                      |
|                     | `KAN-10` | `REQ-003` | דוח הכנסות                   |
|                     | `KAN-11` | `REQ-004` | ניהול עובדים                 |
|                     | `KAN-13` | `REQ-006` | חיפוש משתמשים                |
| **Yossi Gerafi**    | `KAN-12` | `REQ-005` | הוספת מתאמן וניהול מנוי      |
|                     | `KAN-16` | `REQ-009` | חיפוש מתאמנים משויכים        |
|                     | `KAN-17` | `REQ-010` | תיעוד ועדכון התקדמות         |
|                     | `KAN-18` | `REQ-011` | ניהול תוכנית אימונים         |
|                     | `KAN-19` | `REQ-012` | ניהול תפריט תזונה            |
|                     | `KAN-22` | `REQ-015` | צפייה בתוכנית ובתפריט אישיים |
|                     | `KAN-26` | `REQ-019` | צפייה בהתקדמות אישית         |
| **נתנאל בבייב**     | `KAN-14` | `REQ-007` | הוספת שיעור                  |
|                     | `KAN-15` | `REQ-008` | עדכון/ביטול שיעור            |
|                     | `KAN-20` | `REQ-013` | קביעת פגישה                  |
|                     | `KAN-21` | `REQ-014` | עדכון/ביטול פגישה            |
|                     | `KAN-23` | `REQ-016` | חיפוש שיעורים                |
